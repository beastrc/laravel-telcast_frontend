	...
	<div id="sidebar-scrollbar">
		<nav class="iq-sidebar-menu">
			<ul id="iq-sidebar-toggle" class="iq-menu">
				...
				<li class="@if(isCurrentRoute('advertiser.admin.advertisers.index')) active active-menu @endif">
					<a href="{{ route('advertiser.admin.advertisers.index') }}" class="iq-waves-effect">
