<div class="iq-top-navbar bg-white border-bottom">
						...
						<div class="iq-sub-dropdown iq-user-dropdown">
							<div class="iq-card shadow-none m-0">
								<div class="iq-card-body p-0 ">
									...
									<a href="{{ route('profile') }}" class="dropdown-item iq-sub-card border-bottom">
										<div class="media align-items-center">
											<div class="rounded iq-card-icon border">
												<i class="ri-file-user-line"></i>
											</div>
											<div class="media-body ml-3">
												<h6 class="mb-0 ">My Profile</h6>
												<p class="mb-0 font-size-12">Manage your profile details.</p>
											</div>
										</div>
									</a>
									<a href="{{ route('account') }}" class="dropdown-item iq-sub-card border-bottom">
										<div class="media align-items-center">
											<div class="rounded iq-card-icon border">
									...
									<div class="d-inline-block w-100 text-center p-3">
										<form action="{{ route('logout') }}" method="POST">
											@csrf
											<a class="btn btn-primary" href="#!" onclick="this.parentElement.submit();">
