...
<div class="container-fluid">
    <div class="tab-content">
        <form id="campaingForm" method="post" action="{{ url('savecampaign') }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-7">
                        <fieldset class="mb-4">
                            ...
                            <input type="text" class="col-10 form-control h-auto text-black beast_input" id="title" name="title" placeholder="Enter title for ad campaign" required>
                            <div class="alert alert-secondary" style="display:none;" id="alert_name">
                                <i class='fas fa-exclamation'></i>&nbsp;&nbsp; Type Your Name.
                            </div>
                        </fieldset>
                        <fieldset style="margin-left: 20px; margin-bottom: 20px;">
                        ...
                        <div>
                                    ...
                                    <div class="custom-control custom-radio mb-3">
                                        <div class="d-flex ">
                                            <div class="col-12 col-md-5">
                                                <div class="uploader" >
                                                    <img id="uploadimg" src="{{ asset('images/upload.png') }}" style="bo display:block; width: 50%; height:auto;" onclick="openfile()"></img>
                            ...
                            <div id="yes" style="display:none;">
                                <fieldset class="mb-4">
                                    ...
                                    <input type="url" id="videourl" class="col-10 form-control h-auto text-white" name="url" placeholder="Enter url of the landing page starting with http:// or https://">
                                </fieldset>
                            </div>
                        </div>
                    </div>
                    <div class="col-5">
                        ...
                        <div class="rounded overflow-hidden" style="height: 400px; background-color: #404040;">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade px-5 py-3 show active" id="mobile" style="display: none;">
                                    <div class="preview-format-1" >
                                        <div></div>
                                ...
                                <div class="tab-pane fade p-3" id="desktop" style="display: none;">
                                    <div class="preview-format-1" >
            ...
            <div class="tab-pane container active" id="step2" style="display:none;">
                <div class="row">
                    <div class="col-7">
                        <div>
                            <div class="">
                                <label class="text-white"><strong >Where are your customers located? :</strong></label><br/>
                                <select class="selectpicker dropdownlist" multiple data-live-search="true" name="countrylist">
                            ...
                            <div class="">
                                <label class="text-white"><strong> Languages :</strong></label><br/>
                                <select class="selectpicker dropdownlist" multiple data-live-search="true" name="languagelist">
                            ...
                            <div class="container">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="container-fluid d-flex justify-content-around">
                                        ...
                                        <!-- <label id="daily_budget"> -->
                                    </div>
                                    <p class="mt-5 text-center text-white">Estmated weekly performance</p>
                                    <div class="col-md-12 d-flex justify-content-around square mx-auto beast_est_week_per">
                                        <div class="col-4">
            ...
            <div class="tab-pane container">
                <div class="row" style="margin-top: 120px; margin-bottom: 20px;">
                    ...
                    <div class="col-1">
                        ...
                        <div>
                            <button type="button" class="next_btn" id="hidden_next" style="display: none;" onclick="ToNext()"> Next </button>
                        </div>
                    </div>
                <div>
            </div>
        ...
        $(document).ready(function () {
            ...
            $('#campaingForm').ajaxForm({
                ...
                complete: function (xhr) {
                    ...
                    location.href= "http://localhost:8000/createcampaign";
                }
            });
        });
    });
...
//main panel
    $('#format-1').click(function(){
        if(document.getElementById('format-1').checked == true){
