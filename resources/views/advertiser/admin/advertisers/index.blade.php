@extends('layouts.advertiser.admin.app')
...
@section('content')
	<div class="card border">
		<div class="card-header d-flex justify-content-between align-items-center">
			<div class="font-weight-bold" style="font-size: 16px;">ADVERTISERS</div>
			<div>
	...
	<script>
        $(window).on('load', function () {
            new Crud({
                ...
                routes: {
                    index: "{{ route('advertiser.admin.advertisers.index') }}",
                    store: "{{ route('advertiser.admin.advertisers.store') }}",
                },
                callbacks: {
